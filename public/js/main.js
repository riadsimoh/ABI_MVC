...
function myFunction(e) {
  btnText = e.target.className;
  e.preventDefault();
  console.log(e.target.previousElementSibling.firstChild.nextElementSibling);

  var dots = e.target.previousElementSibling.firstChild.nextElementSibling;
  var moreText =
    e.target.previousElementSibling.firstChild.nextElementSibling
      .nextElementSibling;
  if (dots.style.display === 'none') {
    ...
    e.target.innerHTML = 'En savoir moins';
